---
title: Rebuilding Python Bundle
description: Quick guide for rebuilding the Python bundle when troubleshooting production issues
tags:
  - setup
  - python
  - rebuild
...
See [`PYTHON_ENV_ARCHITECTURE.md`](./PYTHON_ENV_ARCHITECTURE.md) for a detailed explanation.
...
See [`PYTHON_ENV_ARCHITECTURE.md`](./PYTHON_ENV_ARCHITECTURE.md) for details.
...
1. Check [`PYTHON_ENV_ARCHITECTURE.md`](./PYTHON_ENV_ARCHITECTURE.md) to understand environment types
2. Check [`PYTHON_BUNDLE_FIX.md`](../troubleshooting/PYTHON_BUNDLE_FIX.md) for detailed technical analysis
