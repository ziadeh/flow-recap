---
title: Windows Local Setup
description: Comprehensive guide for setting up Windows testing environment for FlowRecap development
tags:
  - setup
  - windows
  - testing
...
See [MANUAL_TESTING_CHECKLIST.md](../development/MANUAL_TESTING_CHECKLIST.md) for comprehensive manual testing procedures.
...
- [Windows Compatibility Audit](../development/WINDOWS_COMPATIBILITY_AUDIT.md)
- [Manual Testing Checklist](../development/MANUAL_TESTING_CHECKLIST.md)
