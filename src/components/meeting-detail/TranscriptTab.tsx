...
import { TranscriptViewer, LiveTranscriptViewer, IndividualSpeakerBoxViewer, ChatStyleTranscriptViewer } from '../transcript'
...
export type TranscriptViewMode = 'chat' | 'card' | 'default'
